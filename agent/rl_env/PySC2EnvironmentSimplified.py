...
class PySC2Environment(py_environment.PyEnvironment):
    ...
    def action_spec(self):
        # TODO: Question: Where does the mapping from 0 or 1 to an actual action take place?
    ...
    def _step(self, action):
        ...
        print("Observation of the step function looks like:") # this never gets printed
        print(obs)
